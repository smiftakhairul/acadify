        ...
        <div className="card">
          ...
          <div className="card-body">
            <form>
              ...
              <button type="submit" className="btn btn-primary btn-lg btn-block">Login as Student</button>
            </form>
          </div>
          <div className="card-footer bg-white p-0 text-center">
            <div className="card-footer-item card-footer-item-bordered">
              <Link to="/register" className="footer-link">Create student account</Link>
            </div>
            {/* <div className="card-footer-item card-footer-item-bordered">
