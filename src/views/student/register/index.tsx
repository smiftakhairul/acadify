        ...
        <div className="card">
          <div className="card-header text-center">
            <a href="#" onClick={(e) => e.preventDefault()}>
              <img className="logo-img" src="/img/acadify-student.png" alt="logo" width={280} />
            </a>
          ...
          <div className="card-body">
            <form>
              ...
              <button type="submit" className="btn btn-primary btn-lg btn-block">Register as Student</button>
            </form>
          </div>
          <div className="card-footer bg-white p-0 text-center">
            <div className="card-footer-item card-footer-item-bordered">
              <Link to="/login" className="footer-link">Already a student? Login here.</Link>
            </div>
          </div>
        </div>
      </div>
